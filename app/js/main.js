...
(function () {
  ...
  const burger = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.burger');
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', e => {
    ...
    body === null || body === void 0 ? void 0 : body.classList.toggle('lock');
  });
  overlay === null || overlay === void 0 ? void 0 : overlay.addEventListener('click', () => {
    ...
    body === null || body === void 0 ? void 0 : body.classList.remove('lock');
  });
